...
kubectl --namespace kube-system annotate secret reg1 ex.anz.com/repositories=reg1/image1,reg1/image2,reg1/image3
...
kubectl --namespace kube-system annotate secret reg2 ex.anz.com/repositories=reg2/image1,reg2/image2,reg2/image3
